...
- **Savings Plans**: Reduce your Amazon EC2 costs by making a paying a specific monthly fee for 1 or 3 years.
- **Reserved Instances**: Reduce your Amazon EC2 costs by renting an EC2 instance for 1 or 3 whole years.
- **Spot Instances**: Reduce your Amazon EC2 costs by using otherwise unused EC2 instances. (Caution: They will be shut down if someone starts using them)  
- **Dedicated Hosts**: Pay for a physical host machine. It will be fully dedicated to running your instances. You can bring your existing per-socket, per-core, or per-VM software licenses to reduce costs.
